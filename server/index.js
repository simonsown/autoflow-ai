...
app.put('/api/workflows/:id', (req, res) => {
  ...
  if (old.trigger.type === 'schedule') scheduler.unregister(old.id);
  workflows[idx] = { ...old, ...req.body, id: old.id, updatedAt: new Date().toISOString() };
  writeJSON('workflows.json', workflows);
  if (workflows[idx].trigger.type === 'schedule') scheduler.register(workflows[idx]);
...
app.delete('/api/workflows/:id', (req, res) => {
  ...
  if (wf && wf.trigger.type === 'schedule') scheduler.unregister(wf.id);
